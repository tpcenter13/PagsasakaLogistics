...
export default function HomeScreen() {
  ...
  const buttonPosition = useRef(new Animated.Value(25)).current;
  const logoPosition = useRef(new Animated.Value(45)).current;
  const riderPosition = useRef(new Animated.Value(9)).current;
  const MotorRiderSize = useRef(new Animated.ValueXY({ x: 160, y: 125 })).current;
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Only one Sign In Button needed */}
      <Animated.View
        style={[
          styles.button,
          {
